const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?lat=20.51&lon=-86.95&units=imperial&appid=7d1799cb656dd7ec926774e34069fc68";
...
function displayResults(data) {
    ...
    for (let i = 0; i < data.list.length; i++) {
        ...
        if (forecast.dt_txt.includes("15:00")) {
